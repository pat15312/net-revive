...
- **173 automated tests passed** locally. Tests use mocked UniFi, DNS and internet interactions.
...
The [security assessment](../SECURITY_AUDIT.md) records adversarial tests, source/dependency/image scans, supply-chain hardening and unresolved operational risks. Python dependency scans are clean; inherited OS image advisories remain explicitly tracked.
